/* ==========================================================================
   Vellore Catering World — main.js
...
(function () {
  ...
  var WA_NUMBER = body.getAttribute('data-wa') || '919445978140';
  ...
  $$('form[data-wa-form]').forEach(function (form) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      setTimeout(function () {
        if (status) status.textContent = 'WhatsApp opened. Tap send and we will reply shortly. Prefer a call? Dial 94459 78140.';
        form.reset();
      }, 900);
    });
  });
