...
def area_page(a,idx,areas,blogs):
 ...
 title=f'Catering in {n} | Vellore Catering'; desc=f'Catering in {n} for weddings, birthdays, seemandham and family events. Plan menus, guest count, service style and WhatsApp enquiries with Vellore Catering.'
 ...
 hero=f'<section class="page-hero page-hero--catalog" data-section="3" data-section-name="Hero Banner"><div class="page-hero__media"><img src="../assets/img/areas/{k}-hero.svg" width="1200" height="630" alt="Catering planning for {E(n)}, Vellore" fetchpriority="high"></div><div class="container page-hero__content"><p class="eyebrow">Servicing area · {E(a["area_type"])}</p><h1>Catering in {E(n)}</h1><p class="lead">Wedding catering, birthday catering, seemandham catering and other event menus for {E(n)} with direct WhatsApp enquiry.</p><div class="btn-row"><a class="btn btn--gold" href="#booking">Get a quote</a><a class="btn btn--ghost" href="https://wa.me/{CONFIG["whatsapp"]}?text={quote("Hello Vellore Catering, I need catering in "+n)}">WhatsApp</a></div></div></section>'
...
def blog_page(b,blogs,areas):
 ...
 main=f'''<article class="blog-article"><section class="page-hero page-hero--catalog blog-hero"><div class="page-hero__media"><img src="../../assets/img/blogs/{k}.svg" width="1200" height="630" alt="{E(title)}" fetchpriority="high"></div><div class="container page-hero__content"><p class="eyebrow">Guides · Blogs · {E(cat)}</p><h1>{E(title)}</h1><p class="lead">{E(b['summary'])}</p><div class="blog-meta"><span>Published by Vellore Catering</span><span>Updated {TODAY}</span><span>{E(fmt)}</span></div></div></section><div class="container"><nav class="breadcrumb"><ol><li><a href="../../index.html">Home</a></li><li><a href="../index.html">Guides</a></li><li><a href="index.html">Blogs</a></li><li><span>{E(title)}</span></li></ol></nav></div><section class="section"><div class="container blog-layout"><div class="blog-content"><p>{E(p1)}</p><p>{E(p2)}</p>
...
def blog_index(blogs):
 ...
 meta=head_meta(out,'Catering Blogs & Guides | Vellore Catering',desc)+jsonld(business_schema(),website_schema(),breadcrumb_schema([('Home','index.html'),('Guides','guides/index.html'),('Blogs',out)]))
