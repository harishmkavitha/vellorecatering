...
Steps:
  ...
  6. media_workflow.py reapply-active — restore validated local page media after regeneration
  7. build_sitemap.py   — rewrite sitemap.xml from canonical URLs
  8. quick checks       — duplicate titles/descriptions, missing alt, broken internal links,
...
if __name__ == "__main__":
    ...
    run("media_workflow.py", "reapply-active")
