...
VERSION_RE = re.compile(r"(<!-- Vellore Catering \| [^|]+ \| Version: )V1\b")
GENERATED_RE = re.compile(r"(<!-- Vellore Catering \| [^|]+ \| GENERATED )V2\b")
...
def write_credits():
    ...
    title = "Photo & Video Credits | Vellore Catering"
    desc = ("Credits and licence details for the free Pexels stock photos and videos of South Indian food, "
            "catering and weddings shown on the Vellore Catering website.")
    url = f"{SITE}/credits.html"
    t = re.sub(r"<!-- Vellore Catering \| privacy\.html \| Version: [^>]*-->",
               "<!-- Vellore Catering | credits.html | Version: V1 | generated by tools/stock_media.py -->", t)
...
{chr(10).join(lv) if lv else '            <li>No videos in use.</li>'}
          ...
          <h2>Other assets</h2>
          <p>The Vellore Catering logo and kolam artwork are the business's own. Fonts (Rozha One, Mukta, Tiro Tamil) are used under the SIL Open Font License.</p>
          <p>Are you the creator of an item listed here and want it credited differently or removed? Call or WhatsApp <a href="tel:+919940466250">+91 99404 66250</a>.</p>
...
<meta name="robots" content="noindex, nofollow"><title>Media review | Vellore Catering</title>
<style>
